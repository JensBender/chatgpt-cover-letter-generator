...
+ Moreover, it will add your salary expectations and possible start date and create two cover letter suggestions that you can fine-tune to apply for the job.
